...
const TopNavBar: React.FC = () => {
  ...
  return (
    <header className="border-b border-gray-200/10 dark:border-none h-16 flex items-center justify-between px-6 flex-shrink-0 z-10 bg-white dark:bg-[#09090b] transition-colors duration-300">
      {/* Left Section */}
