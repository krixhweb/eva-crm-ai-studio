...
// Fix: Changed 'name' type annotation to use 'typeof icons' to resolve circular reference error.
// Fix: Explicitly add className to IconProps to fix type errors.
interface IconProps extends React.SVGProps<SVGSVGElement> {
  name: keyof typeof icons;
  className?: string;
}

// A collection of some SVG icons. In a real app, this would be more extensive or from a library.
const icons = {
  ...
  headphones: (props: React.SVGProps<SVGSVGElement>) => (
    <svg {...props} xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
      <path d="M12 2a9 9 0 0 0-9 9v3a2 2 0 0 0 2 2h2a2 2 0 0 0 2-2v-3a9 9 0 0 0-9-9z"/>
      <path d="M21 14v3a2 2 0 0 1-2 2h-2a2 2 0 0 1-2-2v-3a9 9 0 0 1 18 0z"/>
    </svg>
  ),
  watch: (props: React.SVGProps<SVGSVGElement>) => (
    <svg {...props} xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
      ...
      <path d="M16.51 17.35l-.35-1.83a2 2 0 0 0-2-1.52H9.83a2 2 0 0 0-2 1.52l-.35 1.83"/><path d="M7.49 6.65l.35 1.83a2 2 0 0 0 2 1.52h4.33a2 2 0 0 0 2-1.52l.35-1.83"/>
    </svg>
  ),
  usb: (props: React.SVGProps<SVGSVGElement>) => (
    <svg {...props} xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
      <circle cx="10" cy="7" r="1" /><circle cx="4" cy="20" r="1" /><path d="M4.7 19.3L7 17" /><path d="m10.7 7.7-2.4 8.5" /><circle cx="20" cy="20" r="1" /><path d="m18 17 1.3 2.3" /><path d="M12 10h4v4h-4v0a2 2 0 0 1-2-2v0a2 2 0 0 1 2-2v0Z" />
    </svg>
  ),
  ...
  tag: (props: React.SVGProps<SVGSVGElement>) => (
    <svg {...props} xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
      <path d="M12.586 2.586a2 2 0 0 0-2.828 0L2.172 10.172a2 2 0 0 0 0 2.828L10.172 21a2 2 0 0 0 2.828 0l7.586-7.586a2 2 0 0 0 0-2.828L12.586 2.586z"/>
      <line x1="7.5" y1="12.5" x2="7.51" y2="12.51"/>
    </svg>
  ),
