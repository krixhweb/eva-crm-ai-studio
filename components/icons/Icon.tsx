...
// Fix: Changed 'name' type annotation to 'string' to resolve circular reference errors and allow dynamic icon names.
...
const icons = {
  ...
  usb: (props: React.SVGProps<SVGSVGElement>) => (
    <svg {...props} xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
      <circle cx="10" cy="7" r="1" /><circle cx="4" cy="20" r="1" /><path d="M4.7 19.3L7 17" /><path d="m10.7 7.7-2.4 8.5" /><circle cx="20" cy="20" r="1" /><path d="m18 17 1.3 2.3" /><path d="M12 10h4v4h-4v0a2 2 0 0 1-2-2v0a2 2 0 0 1 2-2v0a2 2 0 0 1 2-2v0Z" />
    </svg>
  ),
