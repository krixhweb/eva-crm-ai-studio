...
import AboutTab from './customerProfile/AboutTab';
import ActivityTab from './customerProfile/ActivityTab';
import RevenueTab from './customerProfile/RevenueTab';
import CommunicationsTab from './customerProfile/CommunicationsTab';
